...
export const NFL_TEAMS: Record<string, TeamTheme> = {
  ...
  BUF: { name: "Buffalo Bills", city: "Buffalo", abbreviation: "BUF", primary: "#00338D", secondary: "#C60C30", textOnPrimary: "white", stadium: "Highmark Stadium", division: "AFC East", tagline: "Highmark Stadium · AFC East" },
  ...
  CHI: { name: "Chicago Bears", city: "Chicago", abbreviation: "CHI", primary: "#0B162A", secondary: "#C83803", textOnPrimary: "white", stadium: "Soldier Field", division: "NFC North", tagline: "Soldier Field · NFC North" },
  ...
  DET: { name: "Detroit Lions", city: "Detroit", abbreviation: "DET", primary: "#0076B6", secondary: "#005a8c", textOnPrimary: "white", stadium: "Ford Field", division: "NFC North", tagline: "Ford Field · NFC North" },
  ...
  NE:  { name: "New England Patriots", city: "Boston", abbreviation: "NE", primary: "#002244", secondary: "#C60C30", textOnPrimary: "white", stadium: "Gillette Stadium", division: "AFC East", tagline: "Gillette Stadium · AFC East" },
  NO:  { name: "New Orleans Saints", city: "New Orleans", abbreviation: "NO", primary: "#D3BC8D", secondary: "#101820", textOnPrimary: "black", stadium: "Caesars Superdome", division: "NFC South", tagline: "Caesars Superdome · NFC South" },
  ...
  WAS: { name: "Washington Commanders", city: "Washington", abbreviation: "WAS", primary: "#5A1414", secondary: "#FFB612", textOnPrimary: "white", stadium: "Northwest Stadium", division: "NFC East", tagline: "Northwest Stadium · NFC East" },
};
