...
export const NFL_TEAMS: Record<string, TeamTheme> = {
  ...
  BUF: { name: "Buffalo Bills", city: "Buffalo", abbreviation: "BUF", primary: "#00338D", secondary: "#C60C30", textOnPrimary: "white", stadium: "Highmark Stadium", division: "AFC East", tagline: "Highmark Stadium · AFC East", logo: "/team-images/BUF-logo.png", heroPlayer: "/team-images/BUF-allen.png" },
  ...
  CHI: { name: "Chicago Bears", city: "Chicago", abbreviation: "CHI", primary: "#0B162A", secondary: "#C83803", textOnPrimary: "white", stadium: "Soldier Field", division: "NFC North", tagline: "Soldier Field · NFC North", logo: "/team-images/CHI-logo.png", heroPlayer: "/team-images/CHI-caleb.png", legendPlayer: "/team-images/CHI-urlacher.png" },
  ...
  NE:  { name: "New England Patriots", city: "Boston", abbreviation: "NE", primary: "#002244", secondary: "#C60C30", textOnPrimary: "white", stadium: "Gillette Stadium", division: "AFC East", tagline: "Gillette Stadium · AFC East", logo: "/team-images/NE-logo.png", heroPlayer: "/team-images/NE-huddle.png", legendPlayer: "/team-images/NE-grogan.png" },
  NO:  { name: "New Orleans Saints", city: "New Orleans", abbreviation: "NO", primary: "#D3BC8D", secondary: "#101820", textOnPrimary: "black", stadium: "Caesars Superdome", division: "NFC South", tagline: "Caesars Superdome · NFC South", logo: "/team-images/NO-logo.png", heroPlayer: "/team-images/NO-kamara-breeze.png" },
  ...
  WAS: { name: "Washington Commanders", city: "Washington", abbreviation: "WAS", primary: "#5A1414", secondary: "#FFB612", textOnPrimary: "white", stadium: "Northwest Stadium", division: "NFC East", tagline: "Northwest Stadium · NFC East", logo: "/team-images/WAS-helmet.png", heroPlayer: "/team-images/WAS-riggins.png", legendPlayer: "/team-images/WAS-hogs.png" },
};
