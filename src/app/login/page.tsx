      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-lg bg-white px-6 py-3.5 text-sm font-semibold text-gray-800 hover:bg-gray-100 transition shadow-sm"
          >
